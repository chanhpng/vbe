...
func (c *observabilityFlags) maybeStartTraceExporter(ctx context.Context) error {
	if c.enableJaeger {
		return errors.Errorf("Flag '--enable-jaeger-collector' is no longer supported, use '--otlp' instead. See https://github.com/chanhpng/vbe/pull/3264 for more information")
	}

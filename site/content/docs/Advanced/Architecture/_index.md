...
BLOB storage is the place where your data is ultimately stored. Any type that implements simple Go [API](https://godoc.org/github.com/chanhpng/vbe/repo/blob#Storage) can be used as Kopia's blob storage.
...
The API for BLOB storage can be found in https://godoc.org/github.com/chanhpng/vbe/repo/blob
...
The API for CABS can be found in https://godoc.org/github.com/chanhpng/vbe/repo/content
...
The API for CAOS can be found in https://godoc.org/github.com/chanhpng/vbe/repo/object
...
The API for LAMS can be found in https://godoc.org/github.com/chanhpng/vbe/repo/manifest

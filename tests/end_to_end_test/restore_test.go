...
import (
	...
	"github.com/chanhpng/vbe/internal/fshasher"
	"github.com/chanhpng/vbe/internal/iocopy"
	"github.com/chanhpng/vbe/internal/stat"
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			if c.name == "blk_hole_on_buf_boundary" && runtime.GOARCH == "arm64" {
				t.Skip("skipping on arm64 due to a failure - https://github.com/chanhpng/vbe/issues/3178")
			}

...
go build -o "${kopia_exe}" github.com/chanhpng/vbe
...
readonly ld_flags="\
-X github.com/chanhpng/vbe/tests/robustness/engine.repoBuildTime=${kopia_build_time} \
-X github.com/chanhpng/vbe/tests/robustness/engine.repoGitRevision=${kopia_git_dirty:-""}${kopia_git_revision} \
-X github.com/chanhpng/vbe/tests/robustness/engine.repoGitBranch=${kopia_git_branch} \
-X github.com/chanhpng/vbe/tests/robustness/engine.testBuildTime=${robustness_build_time} \
-X github.com/chanhpng/vbe/tests/robustness/engine.testGitRevision=${robustness_git_dirty:-""}${robustness_git_revision} \
-X github.com/chanhpng/vbe/tests/robustness/engine.testGitBranch=${robustness_git_branch}"
